<?php
function wp_dcl_admin() {
add_options_page('DB Clean Lite Options', 'DB Clean','manage_options', __FILE__, 'wp_dcl_page');
}
function wp_dcl_page(){
?>
<style type="text/css">
...
add_action('admin_menu', 'wp_dcl_admin');
?>
