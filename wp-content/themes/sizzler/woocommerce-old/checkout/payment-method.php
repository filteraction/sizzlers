...
?>
<li class="nav-item wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?>">
	<a class="nav-link <?php echo ($counter==1) ? 'active':'';?>" data-toggle="pill" href="#method_<?php echo esc_attr( $gateway->id ); ?>">
	...
	<!-- commented by gdb : below code removed and added to gdb-payment-fields.php-->
